...
# 处理表格3-10
for table_idx in range(2, 10):  # 索引2-9对应表格3-10
...
# 保存结构
with open('learning_content_regulations_full.json', 'w', encoding='utf-8') as f:
    json.dump(learning_content, f, ensure_ascii=False, indent=2)

print(f"\n内容已保存到 learning_content_regulations_full.json")
print(f"共 {len(learning_content['units'])} 个大单元")