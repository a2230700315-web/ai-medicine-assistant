        ...
        for subunit in unit['subunits']:
            ...
            for detail in subunit['details']:
                ...
                if is_template_content(content):
                    ...
                    print(f"    [OK] 细目 {detail['name']} 内容详细")
                    detailed_count += 1
    
    print(f"\n=== 验证结果 ===")
    print(f"总细目数: {total_details}")
    print(f"模板化细目数: {template_count}")
    print(f"详细细目数: {detailed_count}")
    print(f"详细率: {detailed_count/total_details*100:.2f}%")
    
    return template_count, detailed_count, total_details

if __name__ == '__main__':
    verify_module1_content()
